...
const Auth = {
  register(name, email, password) {
    ...
    const user = { id: 'u' + Date.now(), name, email: normalizedEmail, password, avatar: '', bio: '', location: '', joined: new Date().toLocaleDateString('en-US', { month: 'short', year: 'numeric' }), favorites: [] };
    users.push(user);
    Store.set('users', users);
